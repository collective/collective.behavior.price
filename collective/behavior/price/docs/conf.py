...
project = u'collective.behavior.price'
...
htmlhelp_basename = 'collective.behavior.pricedoc'
...
latex_documents = [
  ('index', 'collective.behavior.price.tex', u'collective.behavior.price Documentation',
...
man_pages = [
    (
        'index',
        'todo',
        u'collective.behavior.price Documentation',
        [u'Taito Horiuchi'],
        1)]
